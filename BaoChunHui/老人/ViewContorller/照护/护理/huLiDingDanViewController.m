...
@interface huLiDingDanViewController ()<TFSheetViewDelegate>
...
- (UIButton *)payButton {
    if (!_payButton) {
        ...
        _payButton.backgroundColor = kRGBA(48, 206, 185, 1);
...
- (void)payOfPageBtnView:(TFSheetView *)btnView showBtnView:(UIButton *)btn {
    btn.backgroundColor = kRGBA(48, 206, 185, 1);
}
- (void)viewDidLoad {
    [super viewDidLoad];
