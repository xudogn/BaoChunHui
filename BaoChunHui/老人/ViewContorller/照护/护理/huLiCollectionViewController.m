//
//  huLiCollectionViewController.m
//  zhaoHuDemo
//
//  Created by BCH on 2016/12/15.
...
#import "huLiDingDanViewController.h"



@interface huLiCollectionViewController ()<HWDatePickerDelegate,UITextFieldDelegate,informationViewDelegate>
...
@implementation huLiCollectionViewController
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    _infoView.priceLb.text = @"￥3600.00";
}
- (UIView *)grayView1 {
    if (!_grayView1) {
...
- (UIView *)icShowView {
    if (!_icShowView) {
        ...
        _icShowView.backgroundColor = kRGBA(48, 206, 185, 1);
...
- (UIButton *)phoneButton {
    if (!_phoneButton) {
        ...
        [_phoneButton setTitleColor:kRGBA(48, 206, 185, 1) forState:UIControlStateNormal];
...
- (UIButton *)onlineButton {
    if (!_onlineButton) {
        ...
        _onlineButton.backgroundColor = kRGBA(48, 206, 185, 1);
...
- (void)btnClicked {
    self.hidesBottomBarWhenPushed = YES;
    huLiDingDanViewController *vc = [[huLiDingDanViewController alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)datePickerView:(HWDatePicker *)datePickerView showCancleBtn:(UIButton *)btn {
    [btn setTitleColor:kRGBA(48, 206, 185, 1) forState:UIControlStateNormal];
}
